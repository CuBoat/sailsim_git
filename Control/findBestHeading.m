function [thetaBest,jibe,thetaJibe,RL,LR] = findBestHeading(poseBoat,T,thetaWind,polarPlot,jibe,thetaJibe,RL,LR)
...
thetaBoat_R_max = thetaWind + alpha;  %set best boat angle to angle of wind
                                      ...
                                      %wind
%Run optimization for 0 <= alpha <= 180, aka the right half of the polar
%plot
...
if ~jibe
    if abs(sin(thetaBoat_R_max - thetaBoat)) < abs(sin(thetaBoat_L_max - thetaBoat))
